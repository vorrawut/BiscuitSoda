...
* <strong>Unique User Analytics: analyse your unique users</strong>
* Statistics by city
...
* location change of the stats counter (place holder)
...
**The Analytics Stats Counter consists of two parts:**

* <strong>Stats Counter plugin</strong><br />
  Non visual core system of Analytics Stats Counter to analyse and count visitors of website, updating this data in the database of website counter;<br />
* <strong>Stats Counter widget</strong><br />
  Visual part of Analytics Stats Counter plugin. The Stats Counter widget is responsible for counter visualisation on website and for counter code output on HTML of website;
...
3. **Important: activate "Stats Counter" widget**

= How to activate "Stats Counter" widget? =
It's easy:<br /> 
in your WordPress installation open admin panel (go to WordPress website back-end)<br />
In main menu click on "Appearance" -> "Widgets". Widget with name “Stats Counter” must be active).
