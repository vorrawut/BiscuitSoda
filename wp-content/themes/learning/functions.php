...
// Customize excerpt word count LengthException
...
function learningWordPress_customize_register( $wp_customize ){
	...
	$wp_customize->add_section('lwp_standard_color', array(
...
function learningWordPress_customize_css(){ ?>
	...
	.site-header nav ul li.current_page_ancestor a:link,
	.site-header nav ul li.current_page_ancestor a:visited{
