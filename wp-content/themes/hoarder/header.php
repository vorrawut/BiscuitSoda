    		...
    		<?php zilla_header_start(); ?>
    			...
    			<div id="logo">
    				...
    				if( zilla_get_option('general_text_logo') == 'on' ) { ?>
    				    <a href="<?php echo home_url('/blog/'); ?>"><?php bloginfo( 'name' ); ?></a>
    				<?php } elseif( zilla_get_option('general_custom_logo') ) { ?>
    				    <a href="<?php echo home_url('/blog/'); ?>"><img src="<?php echo zilla_get_option('general_custom_logo'); ?>" alt="<?php bloginfo( 'name' ); ?>"/></a>
    				<?php } else { ?>
    				    <a href="<?php echo home_url('/blog/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="<?php bloginfo( 'name' ); ?>" width="240" height="30" /></a>
    				<?php } ?>
