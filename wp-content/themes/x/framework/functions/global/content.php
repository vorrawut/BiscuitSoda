...
if ( ! function_exists( 'x_does_not_need_entry_meta' ) ) :
  function x_does_not_need_entry_meta() {
    ...
    $post_condition      = $post_type == 'post' && x_get_option( 'x_blog_enable_post_meta' ) == 0;
    $portfolio_condition = $post_type == 'x-portfolio' && x_get_option( 'x_portfolio_enable_post_meta' ) == 0;
