...
function x_woocommerce_add_remove_product_tabs( $tabs ) {
  ...
  $tab_description     = x_get_option( 'x_woocommerce_product_tab_description_enable', 1 );
  $tab_additional_info = x_get_option( 'x_woocommerce_product_tab_additional_info_enable', 1 );
  $tab_reviews         = x_get_option( 'x_woocommerce_product_tab_reviews_enable', 1 );
