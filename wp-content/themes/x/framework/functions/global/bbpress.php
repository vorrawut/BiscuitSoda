...
// =============================================================================
// FUNCTIONS/GLOBAL/BBPRESS.PHP
// -----------------------------------------------------------------------------
// Sets up the theme for bbPress compatibility.
// =============================================================================
...
if ( ! function_exists( 'x_bbpress_navbar_menu' ) ) :
  function x_bbpress_navbar_menu( $items, $args ) {
    ...
    if ( X_BBPRESS_IS_ACTIVE && x_get_option( 'x_bbpress_header_menu_enable', 0 ) == 1 ) {
      ...
      if ( ! X_BUDDYPRESS_IS_ACTIVE || X_BUDDYPRESS_IS_ACTIVE && x_get_option( 'x_buddypress_header_menu_enable', 0 ) == 0 ) {
        if ( ! is_user_logged_in() ) {
