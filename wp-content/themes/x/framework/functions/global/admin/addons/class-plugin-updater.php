...
class X_Plugin_Updater {
  ...
  public function replace_default_wp_update_message() {
    ...
    add_action( 'after_plugin_row_x-shortcodes/x-shortcodes.php', array( $this, 'custom_plugin_update_row' ), 10, 2 );

    remove_action( 'after_plugin_row_x-shortcodes/x-shortcodes.php', 'wp_plugin_update_row', 10, 2 );
  ...
  public function pre_set_site_transient_update_plugins( $data ) {
    ...
    foreach ( $plugins as $slug => $plugin ) {
      ...
      $remote = X_Update_API::get_product( $plugin->product_slug );
