  ...
  <div class="wrap about-wrap x-addons-home">
    ...
    <header class="x-addons-home-header">
      <div class="x-addons-home-header-text">
        ...
        <?php if ( get_option( $name ) == false ) : ?>
          <div class="about-text"><strong>X is now installed (woo-hoo).</strong> Read on to learn more about product validation, support, and other helpful tools.</div>
        <?php else : ?>
          <div class="about-text"><strong>X is now installed (woo-hoo).</strong> Read on to learn more about various member center resources such as the Knowledge Base, support, and other helpful tools.</div>
        <?php endif; ?>
      </div>
      <div class="x-badge">
